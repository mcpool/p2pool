...
PERSIST = False
WORKER_PORT = 9904
BOOTSTRAP_ADDRS = 'burzuj.net mona.mastercryptopool.net mona2.mastercryptopool.net mona3.mastercryptopool.net pool.hostv.pl p2pool.org solidpool.org'.split(' ')
